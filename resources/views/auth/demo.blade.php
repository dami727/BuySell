...
<body>
    ...
    <div class="container my-3">
        <form action="{{route('login')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="card" id="commpany_overview">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="location_of_bussiness" name="location_of_bussiness" class="form-control" placeholder="Location" value="name">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="annual_sales" class="form-label">Annual sales you Business *</label>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="number_of_spu" class="form-label">Number of SPUs *</label>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="details" class="form-control" placeholder="Others Details" value="Details">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="b_license" class="form-label">Business License *</label>
                                <input type="file" name="b_license" id="b_license" class="form-control p-1">
    ...
    <script>
        $(document).ready(function(){
            $('#commpany_overview').hide();
            $('#account_type').change(function(){
                $('#commpany_overview').show();
            });
        });
    </script>
</body>
